    ...
    public class TranslationCache
    {
        ...
        private void TryLoadLocalManifest(string path)
        {
            if (!File.Exists(path))
            {
                ...
                Plugin.RunOnMainThread(() => Toast.Warn("Translation", "No manifest cache — fetching without hash verification"));
                return;
            }
            ...
            try
            {
                ...
                if (_manifest != null)
                {
                    ...
                    Plugin.RunOnMainThread(() => Toast.Warn("Translation", "Offline — using cached manifest"));
                }
                else
                {
